    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing_fee', models.DecimalField(decimal_places=2, default=Decimal('0'), help_text='Platform listing fee for this event', max_digits=10)),
                ('listing_tier', models.CharField(blank=True, help_text='Pricing tier applied', max_length=50)),
                ('listing_paid', models.BooleanField(default=False, help_text='Has the listing fee been paid?')),
                ('listing_paid_at', models.DateTimeField(blank=True, help_text='When the listing fee was paid', null=True)),
                ('status', models.CharField(choices=[('draft', 'Draft'), ('pending_payment', 'Pending Payment'), ('pending_review', 'Pending Review'), ('approved', 'Approved'), ('published', 'Published'), ('rejected', 'Rejected'), ('completed', 'Completed')], default='draft', help_text='Event status in the system', max_length=20)),
                ('admin_notes', models.TextField(blank=True, help_text='Notes from admin (rejection reasons, etc.)')),
                ('reviewed_at', models.DateTimeField(blank=True, help_text='When the event was reviewed', null=True)),
                ...
                ('reviewed_by', models.ForeignKey(blank=True, help_text='Admin who reviewed this event', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reviewed_events', to=settings.AUTH_USER_MODEL)),
